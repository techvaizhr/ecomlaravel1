...
@media only screen and (min-width:320px) and (max-width:767px) {
	...
	#content {
     margin-left: 0;
     padding-top: <?php echo e($mobileContentPaddingTop); ?>;
   }
   .meta_description {
   	display: none;
   }
...
@media only screen and (min-width: 768px) and (max-width: 991px) {
    ...
    #content {
        padding-top: <?php echo e($hasNewsTicker ? '150px' : '120px'); ?>;
    }
}
...
section.pro_details_area {
    overflow: visible;
}<?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/frontEnd/assets/responsive.blade.php ENDPATH**/ ?>