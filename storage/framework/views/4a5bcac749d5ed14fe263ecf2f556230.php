...
<style>
    ...
    @media (max-width: 991.98px) {
        body.checkout-page #content {
            padding-top: <?php echo e($checkoutMobilePadTop); ?> !important;
        }
...
<section class="checkout-section">
    ...
    <div class="container">
        ...
        <form id="checkout-form" action="<?php echo e(route('customer.ordersave')); ?>" method="POST" data-parsley-validate="">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="checkout_otp" id="checkout_otp_hidden" value="<?php echo e($__otpFieldValue); ?>">
            <?php if(!empty($__showCheckoutOtpModal) && !empty($__checkoutOtpDraft)): ?>
                    ...
                    <div class="checkout-summary-sticky" id="checkoutSummarySticky">
                        <div class="checkout-card">
                            ...
                            <div class="card-body-custom p-0">
                                ...
                                <div class="cart-items-scroll px-4 pt-3 cartlist <?php echo e(Cart::instance('shopping')->count() ? '' : 'is-empty'); ?>" style="overflow-y: auto;">
...
<div class="coupon-wrapper">
    ...
    <?php endif; ?>
        ...
        <form id="checkout_otp_resend_form" method="POST" action="<?php echo e(route('customer.ordersave')); ?>" class="d-none">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" id="checkout_otp_modal_field" class="form-control form-control-lg text-center letter-spacing-wide" maxlength="6"
                            ...
                            value="<?php echo e($__otpFieldValue); ?>">
...
<script>
    ...
    let checkoutOtpPending = <?php echo json_encode((bool) ($__custCheckoutOtpPending ?? false), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>