...
<section class="checkout-section">
    <?php
        ...
        $__checkoutOtpDraft = session('chkotp_reseller_draft', []);
    ...
    <div class="container" style="max-width: 1200px;">
        <form id="checkout-form" action="<?php echo e(route('reseller.checkout.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="checkout_otp" id="reseller_checkout_otp_hidden" value="<?php echo e($__otpFieldValue); ?>">
            <?php if(!empty($__showResellerCheckoutOtpModal) && !empty($__checkoutOtpDraft)): ?>
                <?php $__currentLoopData = ['division_id', 'district_id', 'upazila_id', 'payment_method', 'manual_trx_id', 'manual_sender_number', 'order_note']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $__draftKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($__checkoutOtpDraft[$__draftKey])): ?>
                        <input type="hidden" name="<?php echo e($__draftKey); ?>" value="<?php echo e($__checkoutOtpDraft[$__draftKey]); ?>">
                    <?php endif; ?>
        ...
        <form id="reseller_checkout_otp_resend_form" method="POST" action="<?php echo e(route('reseller.checkout.store')); ?>" class="d-none">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" id="reseller_checkout_otp_modal_field" class="form-control form-control-lg text-center" maxlength="6" inputmode="numeric" autocomplete="one-time-code" placeholder="● ● ● ● ● ●" style="letter-spacing: 0.35em;" value="<?php echo e($__otpFieldValue); ?>">
                        <div class="d-flex flex-wrap gap-2 mt-4 justify-content-between align-items-center">
                            <button type="submit" form="reseller_checkout_otp_resend_form" class="btn btn-outline-secondary btn-sm">OTP আবার পাঠান</button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('reseller_checkout_otp_confirm_btn').addEventListener('click', function () {
        ...
        document.getElementById('reseller_checkout_otp_hidden').value = otp;
...
<?php echo $__env->make('reseller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/reseller/checkout.blade.php ENDPATH**/ ?>