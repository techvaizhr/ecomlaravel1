...
<li class="<?php echo e(request()->routeIs('admin.gemini_chat.*') ? 'active' : ''); ?>">
  <a href="<?php echo e(route('admin.gemini_chat.index')); ?>">
...
<li>
  ...
  <div class="collapse" id="siebar-sitesetting">
    <ul class="nav-second-level">
      ...
      <li class="<?php echo e(request()->routeIs('admin.sale-notification.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.sale-notification.index')); ?>"><i data-feather="bell"></i> Sales Notification Popup</a>
      </li>
      <?php endif; ?>
...
<li>
  ...
  <div class="collapse" id="sidebar-api-integration">
    <ul class="nav-second-level">
      ...
      <li><a href="<?php echo e(route('admin.gemini_ai.edit')); ?>"><i data-feather="cpu"></i> Gemini AI</a></li>
      <li><a href="<?php echo e(route('admin.gemini_chat.index')); ?>"><i data-feather="message-circle"></i> Gemini Assistant</a></li>
    </ul>
  </div>
</li>
<?php endif; ?>
...
<li class="<?php echo e(request()->routeIs('admin.sale-notification.*') ? 'active' : ''); ?>">
  <a href="<?php echo e(route('admin.sale-notification.index')); ?>">
    <i data-feather="bell"></i>
    <span> Sales Notification Popup </span>
  </a>
</li>
...
<?php endif; ?>
    ...
    <?php if(auth()->guard('admin')->check()): ?>
        ...
        <?php echo $__env->make('backEnd.layouts.partials.gemini_admin_chatbot', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
    <?php echo $__env->yieldContent('script'); ?>
  </body>
</html>
<?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>