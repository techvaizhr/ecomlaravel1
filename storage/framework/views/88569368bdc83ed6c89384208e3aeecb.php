                            ...
                            <div class="oe-input-group mb-3">
                                ...
                                <select id="adm_edit_division" class="form-select" name="division_id" required>
                                    ...
                                    <?php $__currentLoopData = ($divisions ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>" <?php echo e($admEdDiv === (int) $d->id ? 'selected' : ''); ?>><?php echo e($d->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="row g-2">
                                <div class="col-12 col-md-6 oe-input-group mb-3 mb-md-0">
                                    ...
                                    <select id="adm_edit_district" class="form-select" name="district_id" required>
                                        <option value=""><?php echo e($admEdDiv ? 'জেলা নির্বাচন করুন' : 'আগে বিভাগ সিলেক্ট করুন'); ?></option>
                                        <?php $__currentLoopData = $editDistricts->where('division_id', $admEdDiv); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($district->id); ?>" <?php echo e($admEdDist === (int) $district->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-12 col-md-6 oe-input-group">
                                    ...
                                    <select id="adm_edit_upazila" class="form-select" name="upazila_id" required>
                                        <option value=""><?php echo e($admEdDist ? 'উপজেলা নির্বাচন করুন' : 'আগে জেলা সিলেক্ট করুন'); ?></option>
                                        <?php $__currentLoopData = $editUpazilas->where('district_id', $admEdDist); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upazila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($upazila->id); ?>" <?php echo e($admEdUp === (int) $upazila->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/backEnd/order/edit.blade.php ENDPATH**/ ?>