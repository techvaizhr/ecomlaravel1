...
<?php $__env->startSection('title', 'Sales Notification'); ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="snx-card">
                ...
                <div class="snx-card-body">
                    <form action="<?php echo e(route('admin.sale-notification.settings')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="d-flex align-items-center justify-content-between p-2 rounded-3 mb-2" style="background:#f0eeff;border:1.5px solid #c4b5fd;">
                            ...
                            <label class="snx-toggle"><input type="checkbox" name="is_enabled" value="1" <?php echo e($setting->is_enabled ? 'checked' : ''); ?>><span class="snx-slider"></span></label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between p-2 rounded-3 mb-2" style="background:#f0fdf4;border:1.5px solid #86efac;">
                            ...
                            <label class="snx-toggle"><input type="checkbox" name="show_real_orders" value="1" <?php echo e($setting->show_real_orders ? 'checked' : ''); ?>><span class="snx-slider"></span></label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between p-2 rounded-3 mb-2" style="background:#fffbeb;border:1.5px solid #fcd34d;">
                            ...
                            <label class="snx-toggle"><input type="checkbox" name="show_fake_orders" value="1" <?php echo e($setting->show_fake_orders ? 'checked' : ''); ?>><span class="snx-slider"></span></label>
                        </div>
                        <hr class="my-2">
                        <div class="row g-2">
                            <div class="col-4">
                                <label class="form-label fw-bold" style="font-size:10px;">দেখানোর সময় (সে)</label>
                                <input type="number" name="display_duration" class="form-control form-control-sm" value="<?php echo e($setting->display_duration); ?>" min="2" max="30">
                            </div>
                            <div class="col-4">
                                <label class="form-label fw-bold" style="font-size:10px;">Min Interval (সে)</label>
                                <input type="number" name="interval_min" class="form-control form-control-sm" value="<?php echo e($setting->interval_min); ?>" min="3" max="60">
                            </div>
                            <div class="col-4">
                                <label class="form-label fw-bold" style="font-size:10px;">Max Interval (সে)</label>
                                <input type="number" name="interval_max" class="form-control form-control-sm" value="<?php echo e($setting->interval_max); ?>" min="5" max="120">
                            </div>
                        </div>
            ...
            <div class="snx-card">
                ...
                <div class="snx-card-body">
                    <form action="<?php echo e(route('admin.sale-notification.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <select class="form-select form-select-sm" onchange="fillProduct(this)">
                                ...
                                <option value="<?php echo e($p->name); ?>" data-url="<?php echo e(route('product', $p->slug)); ?>"><?php echo e($p->name); ?></option>
            ...
            <div class="snx-card">
                ...
                <div class="snx-card-body">
                    <form action="<?php echo e(route('admin.sale-notification.bulk')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-2">
            ...
            <ul class="nav nav-tabs snx-tabs" id="snxTabs">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#tabReal">
                        ✅ Real Orders <span class="badge bg-success ms-1"><?php echo e($realNotifs->count()); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#tabCustom">
                        🎭 Custom <span class="badge bg-warning text-dark ms-1"><?php echo e($customNotifs->count()); ?></span>
                    </a>
                </li>
            </ul>
                        ...
                        <div class="snx-card-body p-0">
                            ...
                            <div class="real-wrap">
                                <table class="table table-hover mb-0" id="real-table">
                                    ...
                                    <tbody id="real-tbody">
                                        <?php $__currentLoopData = $realNotifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="real-row-<?php echo e($n->id); ?>">
                                            <td class="text-muted"><?php echo e($i+1); ?></td>
                                            <td><span class="fw-bold"><?php echo e($n->customer_name); ?></span></td>
                                            <td><span class="d-block text-truncate" style="max-width:200px;" title="<?php echo e($n->product_name); ?>"><?php echo e($n->product_name); ?></span></td>
                                            <td class="text-muted small"><?php echo e($n->created_at ? $n->created_at->diffForHumans() : '-'); ?></td>
                                            <td class="text-center">
                                                <label class="snx-toggle">
                                                    <input type="checkbox" <?php echo e($n->is_active ? 'checked' : ''); ?>

                                                           onchange="toggleItem(<?php echo e($n->id); ?>, this)">
                                                    <span class="snx-slider"></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-outline-danger rounded-pill px-2 py-0"
                                                        onclick="deleteItem(<?php echo e($n->id); ?>, 'real-row-<?php echo e($n->id); ?>')" style="font-size:12px;">✕</button>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                    ...
                    <div class="snx-card" style="border-radius:0 12px 12px 12px;">
                        <div class="snx-card-header red">
                            ...
                            <span class="ms-auto d-flex gap-2">
                                ...
                                <form action="<?php echo e(route('admin.sale-notification.destroy-all')); ?>" method="POST" class="d-inline mb-0"
                        ...
                        <div class="snx-card-body p-0">
                            <?php if($customNotifs->count() > 0): ?>
                            <ul class="snx-list" id="snx-sortable">
                                <?php $__currentLoopData = $customNotifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="snx-item" data-id="<?php echo e($n->id); ?>">
                                    <span class="drag-h">☰</span>
                                    <span class="b-custom">🎭</span>
                                    <span class="sn-name"><?php echo e($n->customer_name); ?></span>
                                    <span class="sn-prod" title="<?php echo e($n->product_name); ?>"><?php echo e($n->product_name); ?></span>
                                    <span class="sn-time"><?php echo e($n->created_at->diffForHumans()); ?></span>
                                    <label class="snx-toggle">
                                        <input type="checkbox" <?php echo e($n->is_active ? 'checked' : ''); ?>
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-danger rounded-pill px-2 py-0 flex-shrink-0"
                                            onclick="deleteItem(<?php echo e($n->id); ?>, null, this)" style="font-size:12px;">✕</button>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                            <?php else: ?>
...
var TOGGLE_URL     = '<?php echo e(url("admin/sale-notification")); ?>';
var REORDER_URL    = '<?php echo e(route("admin.sale-notification.reorder")); ?>';
var SYNC_REAL_URL  = '<?php echo e(route("admin.sale-notification.sync-real")); ?>';
var DEL_ALL_REAL   = '<?php echo e(route("admin.sale-notification.destroy-all-real")); ?>';
...
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/backEnd/sale_notification/index.blade.php ENDPATH**/ ?>