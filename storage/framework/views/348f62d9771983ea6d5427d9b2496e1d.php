...
<div class="container-fluid px-0">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <h2 class="fw-bold mb-0">৳<?php echo e(number_format($totalSales ?? 0, 0)); ?></h2>
        ...
        <div class="col-md-3">
            <div class="stat-card success">
                ...
                <h2 class="fw-bold mb-0"><?php echo e($totalOrders ?? 0); ?></h2>
                <small class="opacity-75"><?php echo e($deliveredOrders ?? 0); ?> delivered</small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="stat-card warning">
                <p class="mb-2 small opacity-90">Pending Orders</p>
                <h2 class="fw-bold mb-0"><?php echo e($pendingOrders ?? 0); ?></h2>
        ...
        <div class="col-md-3">
            <div class="stat-card danger">
                ...
                <h2 class="fw-bold mb-0">৳<?php echo e(number_format($avgOrderValue ?? 0, 0)); ?></h2>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $topProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="product-item d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
                                <?php if($product->product && $product->product->image): ?>
                                    <img src="<?php echo e(asset($product->product->image->image)); ?>" 
                                         alt="<?php echo e($product->product->name); ?>" 
                            ...
                            <div class="flex-grow-1">
                                <h6 class="mb-0 fw-semibold"><?php echo e($product->product->name ?? 'N/A'); ?></h6>
                                <small class="text-muted">Sold: <?php echo e($product->total_sold ?? 0); ?> units</small>
                            </div>
                            <div class="text-end">
                                <p class="mb-0 fw-bold text-success">৳<?php echo e(number_format($product->total_revenue ?? 0, 0)); ?></p>
                            </div>
                        </div>
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="analytics-card">
                <h5 class="fw-bold mb-4 text-primary">Revenue by Month (<?php echo e(date('Y')); ?>)</h5>
                <div class="chart-container">
...
<script>
    ...
    if (statusCtx) {
        const statusData = <?php echo json_encode($orderStatusData ?? []); ?>;
    ...
    if (yearlyCtx) {
        new Chart(yearlyCtx.getContext('2d'), {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($currentYearLabels ?? []); ?>,
                datasets: [{
                    label: 'Revenue (৳)',
                    data: <?php echo json_encode($currentYearRevenue ?? []); ?>,
...
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/vendor/analytics.blade.php ENDPATH**/ ?>