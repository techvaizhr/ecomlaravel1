...
<div class="settings-container">
    ...
    <main class="settings-content">
        ...
        <div id="shop-info" class="tab-content active">
            <form action="<?php echo e(route('vendor.settings.shop-info')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body pb-5">
                        <div class="branding-preview">
                            <div class="banner-preview" style="background-image: url('<?php echo e($vendor->banner ? asset($vendor->banner) : ''); ?>'); background-color: #f1f5f9;">
                            ...
                            <div class="logo-preview">
                                <img src="<?php echo e($vendor->logo ? asset($vendor->logo) : asset('public/backEnd/assets/images/users/avatar-1.jpg')); ?>" alt="Shop Logo">
                            </div>
                        </div>
                    ...
                    <div class="section-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="shop_name" value="<?php echo e(old('shop_name', $vendor->shop_name)); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Owner Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="owner_name" value="<?php echo e(old('owner_name', $vendor->owner_name)); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Business Email</label>
                                <input type="email" class="form-control" name="email" value="<?php echo e(old('email', $vendor->email)); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Contact Phone</label>
                                <input type="text" class="form-control" name="phone" value="<?php echo e(old('phone', $vendor->phone)); ?>" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Shop Address</label>
                                <textarea class="form-control" name="address" rows="3"><?php echo e(old('address', $vendor->address)); ?></textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div id="profile" class="tab-content">
            <div class="section-card">
                ...
                <div class="section-body">
                    <form action="<?php echo e(route('vendor.settings.profile')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="d-flex align-items-center mb-4">
                            <div class="me-4">
                                <img src="<?php echo e($user->image ? asset($user->image) : asset('public/backEnd/assets/images/users/avatar-1.jpg')); ?>" 
        ...
        <div id="password" class="tab-content">
            <div class="section-card">
                ...
                <div class="section-body">
                    <form action="<?php echo e(route('vendor.settings.password')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/creativedesignbd/ecommerce1.creativedesign.com.bd/resources/views/vendor/settings.blade.php ENDPATH**/ ?>