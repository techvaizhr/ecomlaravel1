...
select:focus {
    outline: 0;
    border-color: {{$generalsetting->primary_color ?? '#303d6e'}} !important;
    box-shadow: 0 0 0 3px rgba(48, 61, 110, 0.15) !important;
}
...
/* Mobile (<768px): Banner Auto Height (No White Gap) */
...
.product_item .fa-star, .product_item .fa-star-half-alt {
    font-size: 12px;
}
.pro_btn form {
    text-align: center;
...
@media only screen and (min-width: 992px) {
    ...
    section.slider-section .col-sm-9 {
        padding-left: 15px;
    }

    section.slider-section .home-slider-container {
        border-radius: 5px;
        overflow: hidden;
    }
}
...
section.pro_details_area .product-details-content-row {
    align-items: stretch;
}

section.pro_details_area .description-nav-in-content {
    margin-bottom: 0;
    padding-left: 0;
    padding-right: 0;
    box-shadow: none;
...
section.pro_details_area .product-video-col {
    position: relative;
}
...
section.pro_details_area .container,
section.pro_details_area .product-details-content-row {
    overflow: visible;
}
...
.main-details-page .product-section > .container > .row {
...
/* Floating Category Menu (Non-Home Pages) */
.header-floating-cat-menu {
    ...
    max-height: min(480px, calc(100vh - 135px)) !important;
    background: #ffffff !important;
    box-shadow: 0 16px 36px -4px rgba(15, 23, 42, 0.18), 0 4px 12px rgba(15, 23, 42, 0.08) !important;
    border-radius: 0 0 12px 12px !important;
    border: 1px solid #e2e8f0 !important;
    border-top: 2px solid {{$generalsetting->primary_color}} !important;
...
.header-floating-cat-menu::-webkit-scrollbar {
    width: 5px;
}
.header-floating-cat-menu::-webkit-scrollbar-track {
    background: #f8fafc;
}
.header-floating-cat-menu::-webkit-scrollbar-thumb {
    background: #cbd5e1;
    border-radius: 4px;
}
.header-floating-cat-menu::-webkit-scrollbar-thumb:hover {
    background: #94a3b8;
}
...
.floating-cat-row:last-child {
    border-bottom: none !important;
}
.floating-cat-row-main {
    display: flex !important;
...
.floating-cat-row-main:hover {
    background: #f8fafc !important;
}
.floating-cat-item-link {
    display: flex !important;
    align-items: center !important;
    gap: 10px !important;
    flex: 1 !important;
...
.floating-cat-row-main:hover .floating-cat-item-link {
    color: {{$generalsetting->primary_color}} !important;
}
.floating-cat-icon-wrap {
...
.floating-sub-toggle-btn {
    ...
    align-items: center !important;
    justify-content: center !important;
    transition: color 0.18s ease, transform 0.2s ease !important;
}
.floating-sub-toggle-btn:hover {
    color: {{$generalsetting->primary_color}} !important;
}
.floating-cat-row.open > .floating-cat-row-main .sub-toggle-arrow {
...
.floating-cat-row.open > .floating-sub-list,
.floating-cat-row:hover > .floating-sub-list {
    display: block !important;
}
.floating-sub-row {
    display: block !important;
...
.floating-sub-link .sub-bullet {
    font-size: 10px !important;
    color: #94a3b8 !important;
}
.floating-sub-row-main:hover .floating-sub-link {
    color: {{$generalsetting->primary_color}} !important;
    padding-left: 40px !important;
}
.floating-sub-row-main:hover .sub-bullet {
    color: {{$generalsetting->primary_color}} !important;
}
.floating-child-toggle-btn {
    background: transparent !important;
    border: none !important;
...
.floating-sub-row.open > .floating-sub-row-main .child-toggle-arrow {
    transform: rotate(180deg) !important;
}
.floating-child-list {
    display: none !important;
...
.floating-sub-row.open > .floating-child-list,
.floating-sub-row:hover > .floating-child-list {
    display: block !important;
}
.floating-child-row a {
    display: block !important;
...
/* 🏷️ Modern Clean Home Categories Section */
...
.cat-modern-badge {
    ...
    height: 38px;
    border-radius: 10px;
    background: rgba(48, 61, 110, 0.08);
    color: {{$generalsetting->primary_color}};
    display: flex;
    align-items: center;
    justify-content: center;
...
.cat-modern-viewall:hover {
    background: {{$generalsetting->primary_color}};
    color: #ffffff;
    border-color: {{$generalsetting->primary_color}};
    transform: translateX(2px);
}
.cat-modern-viewall i {
    font-size: 11px;
    transition: transform 0.2s ease;
}
.cat-modern-viewall:hover i {
...
.cat_grid_card:hover {
    ...
    border-color: {{$generalsetting->primary_color ?? '#0f3460'}};
}
.cat_grid_inner {
    position: relative;
    width: 100%;
...
/* Seamless Circular Category Items (Legacy Support) */
.cat-slider-modern {
...
.cat-slider-modern .owl-nav {
    position: static;
}
.cat-slider-modern .owl-nav button.owl-prev,
.cat-slider-modern .owl-nav button.owl-next {
    position: absolute;
    top: calc(50% - 18px);
    width: 36px;
    height: 36px;
...
.cat-slider-modern .owl-nav button.owl-prev:hover,
.cat-slider-modern .owl-nav button.owl-next:hover {
    background: {{$generalsetting->primary_color}} !important;
    color: #ffffff !important;
    border-color: {{$generalsetting->primary_color}} !important;
    transform: scale(1.1);
}
.cat-slider-modern .cat-nav-btn {
    background: transparent;
    border: none;
    color: inherit;
    font-size: 13px;
...
.category-breadcrumb a:hover { color: {{$generalsetting->primary_color}}; }
.category-breadcrumb span { color: #94a3b8; font-size: 13px; }
.category-breadcrumb strong { color: #1e293b; font-size: 13.5px; }
...
.sidebar_item:last-child { border-bottom: none; }
...
.accordion-body.cust_according_body ul li a {
    color: #475569;
    font-size: 13.5px;
    padding: 5px 0;
    display: block;
...
.accordion-body.cust_according_body ul li a:hover {
    color: {{$generalsetting->primary_color}};
    padding-left: 4px;
}
...
/* ----- PRODUCT PAGE (SHOP/CATEGORY) TOP AREA ----- */
.product-section {
    padding: 16px 0 20px;
    background: #f7f9fc;
}

/* ----- SINGLE PRODUCT (DETAILS) PAGE REDESIGN ----- */
.homeproduct.main-details-page {
    background: #f7f9fc;
    padding: 0;
    margin-top: 0;
...
.indicator-item:hover, .indicator-item.active {
    border-color: {{$generalsetting->primary_color}};
}
.indicator-item img {
    width: 100%;
...
.details_right .breadcrumb {
    margin-bottom: 14px;
}
.details_right .breadcrumb ul {
    display: flex;
    flex-wrap: wrap;
    gap: 4px;
    padding: 0;
...
.details_right .breadcrumb ul li span {
    color: #94a3b8;
    font-size: 13px;
}
...
.details-ratting-wrapper i { color: #f59e0b; font-size: 14px; }
.details-ratting-wrapper i.far.fa-star { color: #e2e8f0; }
.details-ratting-wrapper span { font-size: 13px; color: #64748b; }
.all-reviews-button {
    font-size: 13px;
    color: {{$generalsetting->primary_color}};
    text-decoration: underline;
...
.selector-item_radio:checked + .selector-item_label {
    border-color: {{$generalsetting->primary_color}};
    background: {{$generalsetting->primary_color}}18;
    color: {{$generalsetting->primary_color}};
}
...
/* ----- BANNER ADS SECTIONS ----- */
.bottoads_area, .homepage-ads-block {
    margin: 8px 0;
}
.bottoads_inner {
    display: flex;
...
.bottoads_inner .ads_item {
    flex: 1 1 auto;
    overflow: hidden;
    border-radius: 8px;
}
.bottoads_inner .ads_item img {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 8px;
...
.bottoads_inner .ads_item:hover img {
    transform: scale(1.02);
}
.homepage-ads-block img {
    border-radius: 8px;
    overflow: hidden;
    transition: transform 0.4s;
}
.homepage-ads-block a:hover img {
...
@media (max-width: 767px) {
    ...
    .section-title-header .section-title-name { font-size: 15px; }
}

/* ========================================================
   SINGLE PRODUCT & QUICK VARIANT MODAL ENHANCEMENTS
   ======================================================== */
.single_product {
    display: flex !important;
    gap: 12px !important;
...
.quick-variant-modal-dialog {
    ...
    animation: quickModalFadeIn 0.25s cubic-bezier(0.16, 1, 0.3, 1);
}
...
.quick-modal-main-image-wrap img {
    max-width: 100%;
    max-height: 100%;
    object-fit: contain;
    transition: transform 0.3s;
}
.quick-modal-discount-badge {
    position: absolute;
    top: 10px;
    left: 10px;
    background: #ef4444;
...
.quick-stock-status.in-stock {
    background: #ecfdf5;
    color: #059669;
}
.quick-stock-status.out-of-stock {
    background: #fef2f2;
    color: #dc2626;
}
.quick-variant-group {
