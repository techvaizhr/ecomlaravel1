    ...
    function initDeliveryLocationPicker() {
        ...
        function phoneticBangla(str) {
            ...
            var directMap = {
                ...
                'comilla': 'কুমিল্লা', 'coxsbazar': 'কক্সবাজার', 'coxs bazar': 'কক্সবাজার',
                ...
                'godagari': 'গোদাগাড়ী', 'bagha': 'বাঘা', 'charghat': 'চারঘাট',
                'paba': 'পবা', 'puthia': 'পুঠিয়া', 'tanore': 'তানোর',
            ...
            var pat = [
                ...
                ['ee','ী'],['oo','ূ'],['oi','ৈ'],['ou','ৌ'],['au','ৌ'],
                ['ai','াই'],['ei','েই'],['aa','া'],
                ['k','ক'],['g','গ'],['j','জ'],['t','ট'],['d','ড'],['n','ন'],
                ['p','প'],['f','ফ'],['b','ব'],['v','ভ'],['m','ম'],['r','র'],
                ['l','ল'],['s','স'],['h','হ'],['w','ও'],['y','য়'],['z','য'],
                ['a','া'],['i','ি'],['u','ু'],['e','ে'],['o','ো']
            ];
            var res = str;
