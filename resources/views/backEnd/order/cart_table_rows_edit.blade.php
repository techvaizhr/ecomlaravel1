...
@php
    ...
    $total_product_discount += ($lineDiscountVal * $qty);
...
<tr data-row-id="{{ $value->rowId }}" data-product-id="{{ $value->id }}">
  ...
  <td class="align-middle text-center" style="width: 110px;">
    <div class="input-group input-group-sm" style="width: 100px; margin: 0 auto;">
        ...
        <input type="hidden" name="line_discount[{{ $lineDiscountKey }}]" value="{{ $lineDiscountVal }}" class="line-discount-hidden">
    </div>
  </td>
...
@endforeach
@php Session::put('product_discount', $total_product_discount); @endphp
