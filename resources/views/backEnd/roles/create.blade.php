...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h4 class="mb-1 fw-bold text-dark"><i class="fe-plus-circle me-2 text-primary"></i> Create New Role</h4>
            <p class="text-muted small mb-0">Define role name and select permitted system actions by module.</p>
        </div>
    ...
    <form action="{{ route('roles.store') }}" method="POST" data-parsley-validate id="role-form">
        @csrf
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" 
                               ...
                               placeholder="e.g. Sales Manager, Order Handler, Content Editor" required>
                        @error('name')
                    ...
                    <div class="col-md-6 mt-3 mt-md-0">
                        <div class="p-3 bg-light rounded-3 border">
                            <small class="text-muted d-block">
                                <i class="fe-info text-primary me-1"></i> নতুন রোলের একটি স্পষ্ট নাম দিন। নিচে প্রতিটি মডিউল থেকে এই রোলের প্রয়োজনীয় পারমিশনগুলো টিক দিন।
                            </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="module-body">
                        ...
                        <label class="perm-checkbox-label" for="perm_{{ $perm->id }}">
                            <input type="checkbox" class="form-check-input permission-checkbox mod-item-{{ $modSlug }}" 
                                   value="{{ $perm->id }}" id="perm_{{ $perm->id }}" name="permission[]">
        ...
        <div class="row mt-4 mb-4">
            <div class="col-12 text-end">
                <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm fw-bold">
                    <i class="fe-check-circle me-1"></i> Save & Assign Role
                </button>
            </div>
        </div>
    </form>
