...
@section('title', 'Vendor Product Management')
...
<style>
    ...
    .pm-stat-icon.emerald { background: #ecfdf5; color: #10b981; }
    .pm-stat-icon.amber { background: #fffbeb; color: #f59e0b; }
...
@section('content')
<div class="container-fluid pt-3 pm-manage-page">
    
    {{-- Header Banner --}}
    <div class="pm-header-card d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
            <h3 class="mb-1 fw-bold text-white"><i class="fe-shopping-bag me-2"></i> Vendor Products Hub</h3>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4 col-sm-6">
            <div class="pm-stat-card">
                <div class="pm-stat-icon blue"><i class="fe-box"></i></div>
                <div>
                    <div class="text-muted small fw-semibold">Total Vendor Products</div>
                    <h4 class="mb-0 fw-bold">{{ $totalVendorProds }}</h4>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
        ...
        <form method="GET" action="{{ route('products.index') }}" id="filterForm">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-xxl-1 col-xl-2 col-lg-2 col-md-3 col-6">
                    <label class="prod-form-label">Approval</label>
                    <select name="approval_status" class="form-select form-select-sm" style="height: 36px; border-radius: 8px;">
                    ...
                    <div class="d-flex align-items-end gap-1">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                <a href="{{ route('products.index') }}" class="btn btn-light btn-sm border d-flex align-items-center justify-content-center" style="height: 36px; width: 36px; border-radius: 8px;" title="Reset Filters">
    ...
    <div class="pm-table-card">
        ...
        <div class="pm-toolbar">
            ...
            <div class="small text-muted fw-semibold">
                Showing {{ $data->firstItem() ?? 0 }} - {{ $data->lastItem() ?? 0 }} of {{ $data->total() }} Vendor Products
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="10" class="text-center py-5 text-muted">
                            <i class="fe-shopping-bag d-block mb-2" style="font-size:2rem;opacity:.4;"></i>
                            কোনো ভেন্ডর পণ্য পাওয়া যায়নি। ফিল্টার পরিবর্তন করুন বা নতুন পণ্য যোগ করুন।
                        </td>
                    </tr>
                    @endforelse
                </tbody>
