...
<div class="container-fluid pt-3 ws-manage-page">
    ...
    <div class="ws-header-card d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('products.create', ['return_url' => request()->fullUrl()]) }}" class="btn btn-light rounded-pill px-4 py-2 fw-bold text-success shadow-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="fw-bold text-dark" style="max-width:250px;">
                                <a href="{{ route('product', $product->slug) }}" target="_blank" class="text-dark text-decoration-none" title="ওয়েবসাইটে দেখুন">
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-prod">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('products.edit', ['id' => $product->id, 'return_url' => request()->fullUrl()]) }}">
